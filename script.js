...
const salvaOl = () => {
  const olCarrinho = document.querySelector('ol').innerHTML;
  saveCartItems(olCarrinho);
};
...
const carregaLocalStorage = () => {
  const minhaOl = document.querySelector('ol');
  minhaOl.innerHTML = getSavedCartItems();
};
